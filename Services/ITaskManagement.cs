...
namespace TaskManagementApplication.Services
{
    public interface ITaskManagement
    {
        ...
        Task<IList<Models.Task>?> GetAllByFilterAsync(Priority? priority, Status? status, string searchQuery, DateTime? fromDate, DateTime? toDate);
        ...
        Task<Models.Task?> DeleteTaskAsync(int id);
    }
}
